...
const en: Dict = {
  ...
  learning_title: "Master the Landscape Finance Framework",
  learning_subtitle:
    "Accelerate your expertise through five strategic phases — from core concepts and program design to screening financial solutions, project pitching, and analysing real-world case studies.",
  learning_intro_title: "Finance the future of nature",
  learning_intro_body:
    "This course bridges the gap between global capital and local conservation, serving as an implementation platform to finance the future of nature. Through practical tools and the analysis of real WWF case studies, you will learn to structure sustainable financial models that protect biodiversity and mitigate climate risk, enabling you to co-create high-impact strategies alongside your partners in the field.",
  ...
  // Food & Agriculture (nav + página "próximamente")
  nav_food_ag: "Food & Agriculture",
  ...
  fa_cta_navigator: "Find resources",
};
...
const es: Dict = {
  ...
  learning_title: "Domina el marco de Finanzas del Paisaje",
  learning_subtitle:
    "Acelera tu experiencia a través de cinco fases estratégicas — desde los conceptos básicos y el diseño del programa hasta la selección de soluciones financieras, la presentación de proyectos y el análisis de casos reales.",
  learning_intro_title: "Financia el futuro de la naturaleza",
  learning_intro_body:
    "Este curso cierra la brecha entre el capital global y la conservación local, y funciona como plataforma de implementación para financiar el futuro de la naturaleza. A través de herramientas prácticas y el análisis de casos reales de WWF, aprenderás a estructurar modelos financieros sostenibles que protegen la biodiversidad y mitigan el riesgo climático, para co-crear estrategias de alto impacto junto a tus socios en el terreno.",
  learning_phase: "Fase",
  ...
  // Food & Agriculture (nav + página "próximamente")
  nav_food_ag: "Alimentación y Agricultura",
  ...
  fa_cta_navigator: "Buscar recursos",
};
...
const fr: Dict = {
  ...
  learning_title: "Maîtrisez le cadre de la Finance Paysagère",
  learning_subtitle:
    "Développez votre expertise à travers cinq phases stratégiques — des concepts fondamentaux et la conception de programme à la sélection des solutions financières, la présentation de projets et l'analyse de cas réels.",
  learning_intro_title: "Financez l'avenir de la nature",
  learning_intro_body:
    "Ce cours comble le fossé entre le capital mondial et la conservation locale, et sert de plateforme de mise en œuvre pour financer l'avenir de la nature. Grâce à des outils pratiques et à l'analyse d'études de cas réelles de WWF, vous apprendrez à structurer des modèles financiers durables qui protègent la biodiversité et atténuent le risque climatique, pour co-créer des stratégies à fort impact avec vos partenaires de terrain.",
  learning_phase: "Phase",
  ...
  // Food & Agriculture (nav + page « bientôt »)
  nav_food_ag: "Alimentation & Agriculture",
  ...
  fa_cta_navigator: "Trouver des ressources",
};
