...
const en: Dict = {
  ...
  stats_t: "The Reality in Numbers",
  stats_sub: "The facts driving the need for a sustainable financial shift.",
  stat1_n: "$58T",
  stat1_title: "Global Economic Risk",
  stat1_t: "of global GDP — more than half — depends directly on healthy, thriving ecosystems.",
  stat2_n: "+50%",
  stat2_title: "Food Price Threat",
  stat2_t: "Climate risks could drive global cereal prices up by 50% by the year 2050.",
  stat3_n: "$700B",
  stat3_title: "The Funding Gap",
  stat3_t: "The annual biodiversity financing gap needed to reverse ecosystem degradation by 2030.",
  stat4_n: "17 Bt",
  stat4_title: "Annual Carbon Footprint",
  stat4_t: "CO₂e emitted by agrifood systems every year.",
  ...
  navigator_result_fixed:
    "For Latin American professionals turning knowledge into impact. Access key tools and real-world case methodologies funding the region's future.",
  ...
  // Funding Explorer — mapeos de financiación de Climate Focus (Knowledge Hub)
  fx_eyebrow: "FUNDING OPPORTUNITIES",
  fx_title: "Climate & Nature Finance Explorer",
  fx_sub:
    "Browse 360+ funders, programmes and platforms for agri-food systems — global and for Cambodia, Indonesia, Peru and Zambia. Mapping prepared by Climate Focus (July 2026).",
  fx_open: "Open the explorer",
  fx_note: "Mapping content in English.",
  fx_search: "Search by name or keyword",
  fx_filter_instrument: "Instrument",
  fx_filter_access: "Direct access for farmers",
  fx_results: "results",
  fx_download: "Download source files (Excel)",
  fx_tab_global: "Global",
  fx_tab_cambodia: "Cambodia",
  fx_tab_indonesia: "Indonesia",
  fx_tab_peru: "Peru",
  fx_tab_zambia: "Zambia",
  fx_tab_platforms: "Platforms",
  fx_access_yes: "Yes",
  fx_access_no: "No",
  fx_access_maybe: "Maybe",
  fx_d_programme: "Programme",
  fx_d_entity_type: "Entity type",
  fx_d_instruments: "Instruments",
  fx_d_capital: "Capital source",
  fx_d_scale: "Scale",
  fx_d_countries: "Target countries",
  fx_d_size: "Funding size & duration",
  fx_d_frequency: "Funding calls",
  fx_d_targets: "Target groups",
  fx_d_activities: "Activities",
  fx_d_thematic: "Thematic focus",
  fx_d_apply: "Who can apply",
  fx_d_requirements: "Requirements",
  fx_d_enabling: "Enabling environment",
  fx_d_relevance: "Relevance to agri-food financing",
  fx_d_notes: "Notes",
  fx_d_source: "Source",
  fx_empty: "No results with the current filters.",
  toolkit_narrator: "Narrator",
  toolkit_open: "Open",
  toolkit_library: "LIBRARY",
  toolkit_library_title: "Downloadable documents",
  toolkit_library_sub:
    "Practical tools designed to be shared, adapted, and implemented alongside your strategic partners.",
  ...
  aud_community: "Local community or smallholder farmer",
  aud_community_s: "Community group, smallholder, producer cooperative",
...
const es: Dict = {
  ...
  stats_sub: "Los datos que impulsan la necesidad de un giro financiero sostenible.",
  stat1_n: "$58 B",
  stat1_title: "Riesgo económico global",
  stat1_t: "billones de USD del PIB mundial dependen de ecosistemas sanos y prósperos —más de la mitad.",
  stat2_n: "+50%",
  stat2_title: "Amenaza al precio de los alimentos",
  stat2_t: "podrían subir los precios mundiales de los cereales por riesgos climáticos para 2050.",
  stat3_n: "$0,7 B",
  stat3_title: "La brecha de financiamiento",
  stat3_t: "billones de USD de brecha anual en financiamiento de biodiversidad para revertir la degradación a 2030.",
  stat4_n: "17 Gt",
  stat4_title: "Huella de carbono anual",
  stat4_t: "de CO₂e emite cada año el sistema agroalimentario mundial.",
  ...
  navigator_result_fixed:
    "Para profesionales latinoamericanos que convierten el conocimiento en impacto. Accede a herramientas clave y metodologías de casos reales que financian el futuro de la región.",
  ...
  // Funding Explorer — mapeos de financiación de Climate Focus (Knowledge Hub)
  fx_eyebrow: "OPORTUNIDADES DE FINANCIACIÓN",
  fx_title: "Explorador de financiación climática y de naturaleza",
  fx_sub:
    "Explora más de 360 financiadores, programas y plataformas para sistemas agroalimentarios — a nivel global y para Camboya, Indonesia, Perú y Zambia. Mapeo preparado por Climate Focus (julio de 2026).",
  fx_open: "Abrir el explorador",
  fx_note: "El contenido del mapeo está en inglés.",
  fx_search: "Busca por nombre o palabra clave",
  fx_filter_instrument: "Instrumento",
  fx_filter_access: "Acceso directo para productores",
  fx_results: "resultados",
  fx_download: "Descargar archivos fuente (Excel)",
  fx_tab_global: "Global",
  fx_tab_cambodia: "Camboya",
  fx_tab_indonesia: "Indonesia",
  fx_tab_peru: "Perú",
  fx_tab_zambia: "Zambia",
  fx_tab_platforms: "Plataformas",
  fx_access_yes: "Sí",
  fx_access_no: "No",
  fx_access_maybe: "Tal vez",
  fx_d_programme: "Programa",
  fx_d_entity_type: "Tipo de entidad",
  fx_d_instruments: "Instrumentos",
  fx_d_capital: "Origen del capital",
  fx_d_scale: "Escala",
  fx_d_countries: "Países objetivo",
  fx_d_size: "Tamaño y duración de la financiación",
  fx_d_frequency: "Convocatorias",
  fx_d_targets: "Grupos objetivo",
  fx_d_activities: "Actividades",
  fx_d_thematic: "Enfoque temático",
  fx_d_apply: "Quién puede aplicar",
  fx_d_requirements: "Requisitos",
  fx_d_enabling: "Entorno habilitante",
  fx_d_relevance: "Relevancia para la financiación agroalimentaria",
  fx_d_notes: "Notas",
  fx_d_source: "Fuente",
  fx_empty: "No hay resultados con los filtros actuales.",
  toolkit_narrator: "Narrador/a",
  toolkit_open: "Abrir",
  toolkit_library: "BIBLIOTECA",
  toolkit_library_title: "Documentos descargables",
  toolkit_library_sub:
    "Herramientas prácticas pensadas para compartir, adaptar e implementar junto a tus socios estratégicos.",
  ...
  aud_community: "Comunidad local o pequeño productor",
  aud_community_s: "Grupo comunitario, pequeño productor, cooperativa",
...
const fr: Dict = {
  ...
  stats_sub: "Les faits qui justifient un virage financier durable.",
  stat1_n: "58 Bn",
  stat1_title: "Risque économique mondial",
  stat1_t: "billions d'USD du PIB mondial dépendent d'écosystèmes sains et prospères — plus de la moitié.",
  stat2_n: "+50%",
  stat2_title: "Menace sur les prix alimentaires",
  stat2_t: "le climat pourrait faire grimper les prix mondiaux des céréales d'ici 2050.",
  stat3_n: "0,7 Bn",
  stat3_title: "Le déficit de financement",
  stat3_t: "billion d'USD : le déficit annuel de financement de la biodiversité d'ici 2030.",
  stat4_n: "17 Gt",
  stat4_title: "Empreinte carbone annuelle",
  stat4_t: "de CO₂e émises chaque année par les systèmes agroalimentaires.",
  ...
  navigator_result_fixed:
    "Pour les professionnels d'Amérique latine qui transforment le savoir en impact. Accédez aux outils clés et aux méthodologies de cas réels qui financent l'avenir de la région.",
  ...
  // Funding Explorer — mapeos de financiación de Climate Focus (Knowledge Hub)
  fx_eyebrow: "OPPORTUNITÉS DE FINANCEMENT",
  fx_title: "Explorateur de financements climat et nature",
  fx_sub:
    "Parcourez plus de 360 bailleurs, programmes et plateformes pour les systèmes agroalimentaires — au niveau mondial et pour le Cambodge, l'Indonésie, le Pérou et la Zambie. Cartographie préparée par Climate Focus (juillet 2026).",
  fx_open: "Ouvrir l'explorateur",
  fx_note: "Le contenu de la cartographie est en anglais.",
  fx_search: "Rechercher par nom ou mot-clé",
  fx_filter_instrument: "Instrument",
  fx_filter_access: "Accès direct pour les producteurs",
  fx_results: "résultats",
  fx_download: "Télécharger les fichiers sources (Excel)",
  fx_tab_global: "Mondial",
  fx_tab_cambodia: "Cambodge",
  fx_tab_indonesia: "Indonésie",
  fx_tab_peru: "Pérou",
  fx_tab_zambia: "Zambie",
  fx_tab_platforms: "Plateformes",
  fx_access_yes: "Oui",
  fx_access_no: "Non",
  fx_access_maybe: "Peut-être",
  fx_d_programme: "Programme",
  fx_d_entity_type: "Type d'entité",
  fx_d_instruments: "Instruments",
  fx_d_capital: "Origine du capital",
  fx_d_scale: "Échelle",
  fx_d_countries: "Pays ciblés",
  fx_d_size: "Taille et durée du financement",
  fx_d_frequency: "Appels à propositions",
  fx_d_targets: "Groupes cibles",
  fx_d_activities: "Activités",
  fx_d_thematic: "Axe thématique",
  fx_d_apply: "Qui peut postuler",
  fx_d_requirements: "Critères d'éligibilité",
  fx_d_enabling: "Environnement habilitant",
  fx_d_relevance: "Pertinence pour le financement agroalimentaire",
  fx_d_notes: "Notes",
  fx_d_source: "Source",
  fx_empty: "Aucun résultat avec les filtres actuels.",
  toolkit_narrator: "Narratrice",
  toolkit_open: "Ouvrir",
  toolkit_library: "BIBLIOTHÈQUE",
  toolkit_library_title: "Documents téléchargeables",
  toolkit_library_sub:
    "Des outils pratiques conçus pour être partagés, adaptés et mis en œuvre avec vos partenaires stratégiques.",
  ...
  aud_community: "Communauté locale ou petit producteur",
  aud_community_s: "Groupe communautaire, petit producteur, coopérative",
