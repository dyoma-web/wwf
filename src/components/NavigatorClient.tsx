...
const QUESTIONS: Question[] = [
  {
    ...
    label: "Your role",
    q: "What is your role?",
    hint: "This tunes the language of the recommendations.",
    options: [
      { id: "conservation", t: "Conservation professional", s: "NGO, field team, protected area manager", ic: <Leaf /> },
      { id: "finance", t: "Finance", s: "Bank, investor, DFI, foundation", ic: <Coin /> },
      { id: "policy", t: "Policy maker", s: "Government, regulator, agency", ic: <Globe /> },
      { id: "research", t: "Researcher", s: "Academic, think tank, analyst", ic: <Book /> },
    ],
  },
  {
    id: "landscape",
    label: "Landscape type",
    q: "What type of landscape do you work in?",
    hint: "Where your work happens on the ground.",
    options: [
      { id: "terrestrial", t: "Terrestrial", s: "Forests, savannahs, drylands, mountains", ic: <Leaf /> },
      { id: "marine", t: "Marine", s: "Coastal, nearshore, open ocean", ic: <Wave /> },
      { id: "mixed", t: "Mixed", s: "Land-sea interface, deltas, wetlands", ic: <Globe /> },
    ],
  },
  {
    id: "challenge",
    ...
    hint: "The one that most blocks progress today.",
    options: [
      { id: "gap", t: "Financing gap", s: "Insufficient capital reaching the landscape", ic: <Coin /> },
      { id: "subsidies", t: "Harmful subsidies", s: "Public money working against conservation", ic: <Warning /> },
      { id: "private", t: "Lack of private investment", s: "Risk, returns, or readiness barriers", ic: <Bars /> },
    ],
  },
  {
    id: "solution",
    label: "Solution",
    q: "What conservation solution are you pursuing?",
    hint: "Roughly — you can refine later.",
    options: [
      { id: "restoration", t: "Restoration", s: "Reforestation, rewilding, regeneration", ic: <Leaf /> },
      { id: "protected", t: "Protected areas", s: "New, expanded, or better managed", ic: <Globe /> },
      { id: "sus-ag", t: "Sustainable agriculture", s: "Agroforestry, regenerative, certified", ic: <Leaf /> },
      { id: "other", t: "Something else", s: "We still suggest a starting point", ic: <Compass /> },
    ],
  },
];
...
export function NavigatorClient({ locale: _locale }: { locale: Locale }) {
      ...
      <div className="sec-hd">
        <div>
          ...
          <h2 className="h-display" style={{ fontSize: "clamp(30px,4vw,50px)", margin: "8px 0 0" }}>
            Four questions. A clear starting point.
          </h2>
          <p className="lede" style={{ marginTop: 10 }}>
            We won&apos;t give you a dashboard. We&apos;ll point you to the right pathways, templates and cases — then
        ...
        {!done ? (
          <div className="qcard">
            <div className="q-meta">
              QUESTION {step + 1} / {QUESTIONS.length} · {cur.label.toUpperCase()}
            </div>
            <h2>{cur.q}</h2>
            ...
            <div className="qnav">
              ...
              >
                {step === QUESTIONS.length - 1 ? "See my pathways" : "Next"} <Arrow width={14} height={14} />
              </button>
            </div>
          </div>
        ) : (
...
type Pathway = { mk: string; color: string; t: string; s: string; fit: string };
  ...
  return (
    <div>
      <div className="res-card" style={{ marginBottom: 16 }}>
        ...
        >
          A <strong style={{ color: "var(--orange)", fontWeight: 700 }}>{labelFor("role").toLowerCase()}</strong> in{" "}
          <strong style={{ color: "var(--orange)", fontWeight: 700 }}>{labelFor("landscape").toLowerCase()}</strong>{" "}
          landscapes, facing{" "}
          <strong style={{ color: "var(--orange)", fontWeight: 700 }}>{labelFor("challenge").toLowerCase()}</strong>,
          pursuing{" "}
          <strong style={{ color: "var(--orange)", fontWeight: 700 }}>{labelFor("solution").toLowerCase()}</strong>.
        </h2>
      </div>
      ...
      <div style={{ marginTop: 20, display: "flex", gap: 10, flexWrap: "wrap" }}>
        <button className="btn orange">
          Open matching LMS unit <Arrow width={14} height={14} />
        </button>
